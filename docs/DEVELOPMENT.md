...
2. Install [Node.js](https://nodejs.org/) and check the version; this is known to work on v22.19.0.
...
```
> cd C:\Users\alewi\Games\FoundryVTT\Data\modules
> git clone git@github-personal:alewisw/bulk-tasks-ext.git
```
...
Cloning of the `bulk-tasks-ext` module into the `Data/modules/bulk-tasks-ext` directory results in the `modules.json` file being in exactly the correct location to load a module.

In order to use the module:
1. Start FoundryVTT and enter the administration console.
2. Navigate to the "Add-on Modules" tab.
3. The "Bulk Tasks Extended" module should appear in this directory; if it does not restart FoundryVTT.
4. Lock the by right-clicking "Bulk Tasks Extended" and selecting "Lock Module".  This is important to prevent FoundryVTT from automatically updating the module to the released version.
5. Create a new Game World, launch it, and join as a Gamemaster.
6. In the "Manage Modules" menu, enable "Bulk Tasks Extended" and reload the FoundryVTT.
